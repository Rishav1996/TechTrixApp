...
public class DOTA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.dotafableft);
        ...
        FloatingActionButton fab1 = (FloatingActionButton) findViewById(R.id.dotafabright);
